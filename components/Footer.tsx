    ...
    <footer style={{ background: '#111', color: '#fff' }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (max-width: 767px) {
          ...
          .footer-grid { gap: 20px !important; margin-bottom: 16px !important; }
          ...
          .footer-hours { font-size: 11px !important; line-height: 1.6 !important; }
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-info" style={{ fontSize: '13px', color: '#bbb', lineHeight: 1.8 }}>
              ...
              <p>전화: <span className="footer-phone" style={{ fontSize: '20px', fontWeight: 700, color: '#e2a06e' }}>010-8680-8151</span></p>
              <p>이메일: hermann2024@naver.com</p>
              <p className="footer-hours">평일 10:00 - 19:00 (토요일 10:00 - 19:00)</p>
            </div>
          </div>
