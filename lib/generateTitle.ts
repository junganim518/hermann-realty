...
const TEMPLATES = [
  ...
  '[신중동역 {매물종류} {거래유형}] {전용평수} {거래장점} {층수특성}',
  '[신중동역 {매물종류} {거래유형}] {전용평수} {면적표현} {매물종류} {건물특성}',
  '[신중동역 {매물종류} {거래유형}] {전용평수} {건물특성} {거래장점} 도보 5분',
  '[신중동역 초역세권 {매물종류} {거래유형}] {전용평수} {층수특성} {거래장점}',
  '[신중동역 {매물종류} {거래유형}] {전용평수} {면적표현} {매물종류} {거래장점} 추천',
  '[부천 {매물종류} {거래유형}] {전용평수} {역세권} {거래장점} {건물특성}',
  '[부천 {매물종류} {거래유형}] {전용평수} {층수특성} {거래장점} 공실',
  '[부천 {매물종류} {거래유형}] {전용평수} {면적표현} {매물종류} {건물특성}',
  '[부천 {매물종류} {거래유형}] {전용평수} {거래장점} {층수특성} 추천매물',
  '[부천 {매물종류} {거래유형}] {전용평수} {건물특성} {면적표현} {매물종류} {거래장점}',
];
